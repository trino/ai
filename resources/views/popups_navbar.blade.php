<nav class=" dont-print bg-danger text-white " style="padding:1rem 0;z-index: 1;border-radius: 0 !important;">
    <div class="container-fluid">
        <a HREF="<?= webroot("public/index"); ?>" onclick="history.go(0);" class="text-white text-center" style="font-family: 'Pacifico', cursive;letter-spacing: .1rem !important;font-size: 1.25rem " href="#">
