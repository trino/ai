...
<nav class="navbar-default bg-danger navbar-fixed-bottom navbar hidden-sm-up navbar-dark" style="z-index: 1;background:#fff;">
<button class="btn pull-left" onclick="window.scrollTo(0,document.body.scrollHeight);">
<strong id="checkout-total"></strong></button>
