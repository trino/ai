...
<head>
    ...
    <body style="overflow-x: hidden !important;background:#f7f7f7; ">
        ...
        <div class="modal" id="alertmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
...
<nav id="checkout-btn" class="navbar-default bg-danger navbar-fixed-bottom navbar hidden-sm-up"
    ...
    <button class="btn bg-black pull-right" ONCLICK="confirm2('Are you sure you want to clear your order?', 'Clear Order', function(){clearorder();});">
        CLEAR
    </button>
</nav>
