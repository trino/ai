...
<?php
    ...
    if(!isset($_GET["search"]) || !trim($_GET["search"]) || !$isKeyword){
        ...
        $results["words"] = "";
        echo view("popups_itemsearch", array("SortColumn" => $results["SortColumn"], "SortDirection" => $results["SortDirection"], "isKeyword" => $isKeyword, "searchstring" => $_GET["search"], "wordstoignore" => $wordstoignore, "quantities" => $quantities))->render();
    } else{
                ...
                foreach($results["is5keywords"] as $primaryKeyID){
                    ...
                    if(count($indexes) > 1){
                        ...
                        foreach($indexes as $index){
                            ...
                            echo view("popups_itemsearch", array("SortColumn" => $results["SortColumn"], "SortDirection" => $results["SortDirection"], "keywordids" => $keywordids, "text" => $newtext, "wordstoignore" => $wordstoignore, "primarykeyid" => $primaryKeyID, "is5keywords" => $results["is5keywords"], "keywords" => $results["keywords"], "limit" => $results["limit"], "quantities" => $quantities))->render();
                            echo '</DIV>';
                        }
                    } else {
                        echo view("popups_itemsearch", array("SortColumn" => $results["SortColumn"], "SortDirection" => $results["SortDirection"], "keywordids" => $keywordids, "text" => $_GET["search"], "wordstoignore" => $wordstoignore, "primarykeyid" => $primaryKeyID, "is5keywords" => $results["is5keywords"], "keywords" => $results["keywords"], "limit" => $results["limit"], "quantities" => $quantities))->render();
                    }
                }
            } else if ($results["non5keywords"]){//no weight-5 keywords found, run a single search of all the keywords
                echo view("popups_itemsearch", array("SortColumn" => $results["SortColumn"], "SortDirection" => $results["SortDirection"], "keywordids" => $results["non5keywords"], "text" => $_GET["search"], "wordstoignore" => $wordstoignore, "keywords" => $results["keywords"], "limit" => $results["limit"], "quantities" => $quantities))->render();
            }
        } else {
