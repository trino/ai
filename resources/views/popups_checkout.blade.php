...
<div class="card text-white  mb-0 pb-0">
...
//can only be included once, and is in the login modal
                        ...
                        <input type="text" class="form-control" ID="restaurant" placeholder="Closest Restaurant"
                               READONLY TITLE="Closest restaurant"/>
                    ...
                    <div class="row ">
                        ...
                        <a class="btn btn-warning text-white pull-right" onclick="payfororder();">PLACE ORDER</a></div>
