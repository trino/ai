...
<div class="clearfix"></div>
                    ...
                    <div class="input_right">
                        ...
                        <button style="" class="pull-right list-padding radius0 btn btn-primary text-white payfororder" onclick="payfororder(); return false;"> <i class="fa fa-check mr-2"></i> ORDER</button>
